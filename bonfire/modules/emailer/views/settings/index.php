<div class="admin-box fx_field_wdth">
    <?php echo form_open(SITE_AREA . '/settings/emailer', 'class="form-horizontal"'); ?>
        <fieldset>
            <legend class="head-title"><?php echo lang('emailer_general_settings'); ?></legend>
        ...
        <fieldset>
            <legend class="head-title"><?php echo lang('emailer_settings'); ?></legend>
            <?php /* PHP Mail */ ?>
            <div id="mail" class="control-group" style="border-bottom: none;padding-bottom: 0;">
                <p class="intro" style="text-align: left;"><?php echo lang('emailer_settings_note'); ?></p>
            </div>
            <?php /* Sendmail */ ?>
        ...
        <fieldset class="form-actions mrgn-btm">
...
<div class="admin-box fx_field_wdth">
    ...
    <?php echo form_open(SITE_AREA . '/settings/emailer/test', array('class' => 'form-horizontal', 'id'=>'test-form')); ?>
        <fieldset>
            <legend class="head-title"><?php echo lang('emailer_test_settings') ?></legend>
            <div class='control-group'>
                <p class="intro" style="text-align: left;"><?php echo lang('emailer_test_intro'); ?></p>
            </div>
            <div class="control-group">
                <label class="control-label" for="test-email"><?php echo lang('bf_email'); ?></label>
                <div class="controls">
                    <input type="email" name="email" id="test-email" class="form-control" value="<?php echo set_value('test_email', settings_item('site.system_email')); ?>" style="display:  inline-block;vertical-align:  middle;margin-top: 2px;" />
                    <input type="submit" name="test" class="btn btn-primary mrgn-tp" value="<?php echo lang('emailer_test_button'); ?>" />
                </div>
            </div>
        </fieldset>
    <?php echo form_close(); ?>
