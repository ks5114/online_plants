    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            <div class='control-group'>
                <label class='control-label col-md-3' for='email_subject'><?php echo lang('emailer_email_subject'); ?></label>
                <div class='controls'>
                    <input type="text" size="50" name="email_subject" class="form-control" id="email_subject" value="<?php if (isset($email_subject)) { e($email_subject); } ?>" />
                </div>
            </div>
            <div class='control-group'>
                <label class='control-label col-md-3' for='email_content'><?php echo lang('emailer_email_content'); ?></label>
                <div class='controls'>
                    <textarea name="email_content" id="email_content" class="form-control" rows="8"><?php
