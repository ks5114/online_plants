...
<div class="control-group<?php echo form_error('email') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="form-control input-medium <?php echo $controlClass; ?>" type="text" id="email" name="email" value="<?php echo set_value('email', isset($user) ? $user->email : ''); ?>" />
...
<div class="control-group<?php echo form_error('display_name') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="form-control input-medium <?php echo $controlClass; ?>" type="text" id="display_name" name="display_name" value="<?php echo set_value('display_name', isset($user) ? $user->display_name : ''); ?>" />
        <div class="clearfix"></div>
...
<div class="control-group<?php echo form_error('username') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="form-control input-medium <?php echo $controlClass; ?>" type="text" id="username" name="username" value="<?php echo set_value('username', isset($user) ? $user->username : ''); ?>" />
        <div class="clearfix"></div>
...
<div class="control-group<?php echo form_error('password') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="form-control input-medium <?php echo $controlClass; ?>" type="password" id="password" name="password" value="" />
        <div class="clearfix"></div>
...
<div class="control-group<?php echo form_error('pass_confirm') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <input class="form-control input-medium <?php echo $controlClass; ?>" type="password" id="pass_confirm" name="pass_confirm" value="" />
        <div class="clearfix"></div>
...
<div class="control-group<?php echo form_error('force_password_reset') ? $errorClass : ''; ?>">
    <div class="controls">
        <label class="custm-checkbox" for="force_password_reset">
...
<div class="control-group<?php echo form_error('language') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <select name="language" id="language" class="form-control input-medium chzn-select <?php echo $controlClass; ?>">
