...
$errorClass = ' error';
$controlClass = 'span6 form-control input-medium';
$fieldData = array(
...
?>
    ...
    <legend class="head-title"><?php echo lang('us_account_details'); ?></legend>
    <div class="middle-body">
        ...
        <fieldset class="form-actions">
            ...
            <?php echo lang('bf_or') . ' ' . anchor(SITE_AREA . '/settings/users', lang('bf_action_cancel'), array('class'=>'btn btn-secondary')); ?>
        </fieldset>
   </div>
    </div>
    </div>
