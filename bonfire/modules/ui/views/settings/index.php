...
<?php endif; ?>
<p class='intro' style="text-align: left;"><?php echo lang('ui_keyboard_shortcuts'); ?></p>
<div class="admin-box">
    <?php echo form_open($this->uri->uri_string(), array('class' => "form-horizontal", 'id' => 'shortcut_form')); ?>
        <table class="table table-striped table-condensed">
            ...
            <tbody>
                <tr>
                    <th>
                        <select name="new_action" class="span4 form-control">
                            <?php
                    ...
                    <td><input type="text" name="new_shortcut" class="medium form-control" value="<?php echo set_value('new_shortcut'); ?>" /></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="shortcut_<?php echo $action;?>" value="<?php echo set_value("shortcut_$action", $shortcut); ?>" class="form-control" /></td>
