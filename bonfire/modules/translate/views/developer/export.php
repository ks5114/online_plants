<p class="intro" style="text-align: left;"><?php echo lang('translate_export_note'); ?></p>
<div class='admin-box fx_field_wdth'>
    <?php echo form_open(current_url(), 'class="form-horizontal"'); ?>
        <fieldset>
            <div class="control-group">
                <label for="export_lang" class="control-label col-md-3" style="width: 180px !important;"><?php echo lang('translate_language'); ?></label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label col-md-3" style="width: 180px !important;"><?php echo lang('translate_include'); ?></label>
                <div class="controls">
